CREATE TYPE "public"."member_role" AS ENUM('admin', 'teacher', 'student');--> statement-breakpoint
...
CREATE TABLE "institution_domains" (
	...
	CONSTRAINT "institution_domains_domain_unique" UNIQUE("domain")
);
...
CREATE TABLE "institutions" (
	...
	"name" text NOT NULL,
	"slug" text NOT NULL,
	"auto_provision_students" boolean DEFAULT true NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "exam_sessions" ADD COLUMN "student_user_id" text;--> statement-breakpoint
ALTER TABLE "teachers" ADD COLUMN "user_id" text;--> statement-breakpoint
...
ALTER TABLE "institution_domains" ADD CONSTRAINT "institution_domains_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "institution_members" ADD CONSTRAINT "institution_members_granted_by_users_id_fk" FOREIGN KEY ("granted_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "pending_role_grants" ADD CONSTRAINT "pending_role_grants_institution_id_institutions_id_fk" FOREIGN KEY ("institution_id") REFERENCES "public"."institutions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "institution_members_user_idx" ON "institution_members" USING btree ("institution_id","user_id");--> statement-breakpoint
CREATE INDEX "accounts_user_idx" ON "accounts" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "sessions_user_idx" ON "sessions" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "verifications_identifier_idx" ON "verifications" USING btree ("identifier");--> statement-breakpoint
ALTER TABLE "exam_sessions" ADD CONSTRAINT "exam_sessions_student_user_id_users_id_fk" FOREIGN KEY ("student_user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
